...
define("EW_PROJECT_NAME", "sistemagestaoigreja", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{2B7992FC-5911-46A7-9310-01F4D4225C49}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'oMqfrovMxQuJ7ITX', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/sistemagestaoigreja.css", TRUE); // Project stylesheet file name
...
define("EW_ADMIN_USER_NAME", "Admin2", TRUE); 
define("EW_ADMIN_PASSWORD", "707090", TRUE); 
define("EW_USE_CUSTOM_LOGIN", TRUE, TRUE); 
...
define("EW_USER_ID_FILTER", "(`u` = %u)",  TRUE);
...
define("EW_SMTP_SERVER", $_SESSION['se'], TRUE); // SMTP server
define("EW_SMTP_SERVER_PORT", $_SESSION['po'], TRUE); // SMTP server port
define("EW_SMTP_SECURE_OPTION", $_SESSION['sc'], TRUE);
define("EW_SMTP_SERVER_USERNAME", $_SESSION['us'], TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", $_SESSION['pw'], TRUE); // SMTP server password
define("EW_SENDER_EMAIL", $_SESSION['em'], TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", $_SESSION['em'], TRUE); // Recipient email address
...
// File upload
define("EW_UPLOAD_DEST_PATH", "fotosmembros/", TRUE); // Upload destination path (relative to app root)
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,xls,pdf,zip,rar,docx,xlsx", TRUE); // Allowed file extensions
...
define("EW_AUTO_SUGGEST_MAX_ENTRIES", 30, TRUE);
