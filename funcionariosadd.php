...
class cfuncionarios_add extends cfuncionarios {
	...
	function LoadDefaultValues() {
		$this->EhMembro->CurrentValue = NULL;
		$this->EhMembro->OldValue = $this->EhMembro->CurrentValue;
		$this->Data_Admissao->CurrentValue = NULL;
		$this->Data_Admissao->OldValue = $this->Data_Admissao->CurrentValue;
		$this->Nome->CurrentValue = NULL;
		$this->Nome->OldValue = $this->Nome->CurrentValue;
		$this->Data_Nasc->CurrentValue = NULL;
		$this->Data_Nasc->OldValue = $this->Data_Nasc->CurrentValue;
		...
		$this->Telefone_Fixo->CurrentValue = NULL;
		$this->Telefone_Fixo->OldValue = $this->Telefone_Fixo->CurrentValue;
		$this->_Email->CurrentValue = NULL;
		$this->_Email->OldValue = $this->_Email->CurrentValue;
		$this->Cargo->CurrentValue = NULL;
		$this->Cargo->OldValue = $this->Cargo->CurrentValue;
		$this->Setor->CurrentValue = NULL;
		$this->Setor->OldValue = $this->Setor->CurrentValue;
		...
		$this->Org_Exp->CurrentValue = NULL;
		$this->Org_Exp->OldValue = $this->Org_Exp->CurrentValue;
		$this->Data_Expedicao->CurrentValue = NULL;
		$this->Data_Expedicao->OldValue = $this->Data_Expedicao->CurrentValue;
		$this->CTPS_N->CurrentValue = NULL;
		$this->CTPS_N->OldValue = $this->CTPS_N->CurrentValue;
		$this->CTPS_Serie->CurrentValue = NULL;
		$this->CTPS_Serie->OldValue = $this->CTPS_Serie->CurrentValue;
		$this->Titulo_Eleitor->CurrentValue = NULL;
		$this->Titulo_Eleitor->OldValue = $this->Titulo_Eleitor->CurrentValue;
		$this->Numero_Filhos->CurrentValue = NULL;
		$this->Numero_Filhos->OldValue = $this->Numero_Filhos->CurrentValue;
		...
		$this->Qual_ano->CurrentValue = NULL;
		$this->Qual_ano->OldValue = $this->Qual_ano->CurrentValue;
		$this->Observacoes->CurrentValue = NULL;
		$this->Observacoes->OldValue = $this->Observacoes->CurrentValue;
		$this->Inativo->CurrentValue = NULL;
		$this->Inativo->OldValue = $this->Inativo->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// EhMembro
		$this->EhMembro->SetDbValueDef($rsnew, $this->EhMembro->CurrentValue, NULL, FALSE);

		// Data_Admissao
		$this->Data_Admissao->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->Data_Admissao->CurrentValue, 7), NULL, FALSE);

		// Nome
		$this->Nome->SetDbValueDef($rsnew, $this->Nome->CurrentValue, "", FALSE);

		// Data_Nasc
		$this->Data_Nasc->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->Data_Nasc->CurrentValue, 7), NULL, FALSE);
		...
		// UF
		$this->UF->SetDbValueDef($rsnew, $this->UF->CurrentValue, NULL, strval($this->UF->CurrentValue) == "");
		...
		// Telefone Fixo
		$this->Telefone_Fixo->SetDbValueDef($rsnew, $this->Telefone_Fixo->CurrentValue, NULL, FALSE);
		...
		// Setor
		$this->Setor->SetDbValueDef($rsnew, $this->Setor->CurrentValue, NULL, FALSE);
		...
		// Org_Exp
		$this->Org_Exp->SetDbValueDef($rsnew, $this->Org_Exp->CurrentValue, NULL, FALSE);

		// Data_Expedicao
		$this->Data_Expedicao->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->Data_Expedicao->CurrentValue, 7), NULL, FALSE);

		// CTPS_N
		$this->CTPS_N->SetDbValueDef($rsnew, $this->CTPS_N->CurrentValue, NULL, FALSE);

		// CTPS_Serie
		$this->CTPS_Serie->SetDbValueDef($rsnew, $this->CTPS_Serie->CurrentValue, NULL, FALSE);

		// Titulo_Eleitor
		$this->Titulo_Eleitor->SetDbValueDef($rsnew, $this->Titulo_Eleitor->CurrentValue, NULL, FALSE);

		// Numero_Filhos
		$this->Numero_Filhos->SetDbValueDef($rsnew, $this->Numero_Filhos->CurrentValue, NULL, FALSE);
		...
		// Qual_ano
		$this->Qual_ano->SetDbValueDef($rsnew, $this->Qual_ano->CurrentValue, NULL, FALSE);

		// Observacoes
		$this->Observacoes->SetDbValueDef($rsnew, $this->Observacoes->CurrentValue, NULL, FALSE);

		// Inativo
		$this->Inativo->SetDbValueDef($rsnew, $this->Inativo->CurrentValue, NULL, FALSE);
...
<script type="text/javascript">
ew_CreateCalendar("ffuncionariosadd", "x_Data_Nasc", "%d/%m/%Y");
</script>
<?php } ?>
</span>
