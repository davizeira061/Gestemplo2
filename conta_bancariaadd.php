...
$conta_bancaria_add = NULL; // Initialize page object first

class cconta_bancaria_add extends cconta_bancaria {
	...
	// Page object name
	var $PageObjName = 'conta_bancaria_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "conta_bancariaview.php")
	...
	function LoadDefaultValues() {
		...
		$this->Agencia->CurrentValue = NULL;
		$this->Agencia->OldValue = $this->Agencia->CurrentValue;
		$this->Conta->CurrentValue = NULL;
		$this->Conta->OldValue = $this->Conta->CurrentValue;
		$this->Gerente->CurrentValue = NULL;
		$this->Gerente->OldValue = $this->Gerente->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// Agencia
		$this->Agencia->SetDbValueDef($rsnew, $this->Agencia->CurrentValue, NULL, FALSE);

		// Conta
		$this->Conta->SetDbValueDef($rsnew, $this->Conta->CurrentValue, NULL, FALSE);

		// Gerente
		$this->Gerente->SetDbValueDef($rsnew, $this->Gerente->CurrentValue, NULL, FALSE);

		// Telefone
		$this->Telefone->SetDbValueDef($rsnew, $this->Telefone->CurrentValue, NULL, FALSE);

		// Limite
		$this->Limite->SetDbValueDef($rsnew, $this->Limite->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($conta_bancaria_add)) $conta_bancaria_add = new cconta_bancaria_add();

// Page init
$conta_bancaria_add->Page_Init();

// Page main
$conta_bancaria_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$conta_bancaria_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var conta_bancaria_add = new ew_Page("conta_bancaria_add");
conta_bancaria_add.PageID = "add"; // Page ID
var EW_PAGE_ID = conta_bancaria_add.PageID; // For backward compatibility

// Form object
var fconta_bancariaadd = new ew_Form("fconta_bancariaadd");

// Validate form
fconta_bancariaadd.Validate = function() {
...
fconta_bancariaadd.Form_CustomValidate = 
...
fconta_bancariaadd.ValidateRequired = true;
<?php } else { ?>
fconta_bancariaadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fconta_bancariaadd.Lists["x_Banco"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_N_do_Banco","x_Banco","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $conta_bancaria_add->ShowPageHeader(); ?>
<?php
$conta_bancaria_add->ShowMessage();
?>
<form name="fconta_bancariaadd" id="fconta_bancariaadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($conta_bancaria_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $conta_bancaria_add->Token ?>">
<?php } ?>
...
<?php } ?>
<script type="text/javascript">
fconta_bancariaadd.Lists["x_Banco"].Options = <?php echo (is_array($conta_bancaria->Banco->EditValue)) ? ew_ArrayToJson($conta_bancaria->Banco->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fconta_bancariaadd.Init();
</script>
<?php
$conta_bancaria_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$conta_bancaria_add->Page_Terminate();
?>
