...
<input type="hidden" name="export" id="export" value="email">
	<div class="form-group">
		...
		<div class="col-sm-10"><input type="text" class="form-control ewControl" name="sender" id="sender" value="<?php echo $_SESSION['email']; ?>"></div>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="recipient"><?php echo $Language->Phrase("EmailFormRecipient") ?></label>
		<div class="col-sm-10"><input type="text" class="form-control ewControl" name="recipient" id="recipient" size="40"></div>
	</div>
	<div class="form-group">
