...
$Lista_de_Emails = NULL;

//
// Table class for Lista_de_Emails
//
class cLista_de_Emails extends cTable {
	var $_Email;
	var $Funcao;
	...
	function __construct() {
		...
		$this->TableVar = 'Lista_de_Emails';
		$this->TableName = 'Lista_de_Emails';
		...
		// Email
		$this->_Email = new cField('Lista_de_Emails', 'Lista_de_Emails', 'x__Email', 'Email', 'Concat(membro.Email, \',\')', 'Concat(membro.Email, \',\')', 200, -1, FALSE, 'Concat(membro.Email, \',\')', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Email'] = &$this->_Email;

		// Funcao
		$this->Funcao = new cField('Lista_de_Emails', 'Lista_de_Emails', 'x_Funcao', 'Funcao', 'membro.Funcao', 'membro.Funcao', 16, -1, FALSE, 'membro.Funcao', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Funcao->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Funcao'] = &$this->Funcao;

		// CargoMinisterial
		$this->CargoMinisterial = new cField('Lista_de_Emails', 'Lista_de_Emails', 'x_CargoMinisterial', 'CargoMinisterial', 'membro.CargoMinisterial', 'membro.CargoMinisterial', 16, -1, FALSE, 'membro.CargoMinisterial', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlSelect() { // Select
		return ($this->_SqlSelect <> "") ? $this->_SqlSelect : "SELECT Concat(membro.Email, ',') AS Email, membro.Funcao, membro.CargoMinisterial FROM " . $this->getSqlFrom();
	}
	...
	function getSqlWhere() { // Where
		$sWhere = ($this->_SqlWhere <> "") ? $this->_SqlWhere : "(membro.Email <> '') OR (NOT membro.Email IS NULL)";
		$this->TableFilter = "";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "lista_de_emailslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("lista_de_emailsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("lista_de_emailsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "lista_de_emailsadd.php?" . $this->UrlParm($parm);
		else
			return "lista_de_emailsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("lista_de_emailsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("lista_de_emailsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("lista_de_emailsdelete.php", $this->UrlParm());
	}
