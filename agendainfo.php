...
class cagenda extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('agenda', 'agenda', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// Prioridade
		$this->Prioridade = new cField('agenda', 'agenda', 'x_Prioridade', 'Prioridade', '`Prioridade`', '`Prioridade`', 16, -1, FALSE, '`Prioridade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Prioridade->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Prioridade'] = &$this->Prioridade;

		// Data
		$this->Data = new cField('agenda', 'agenda', 'x_Data', 'Data', '`Data`', 'DATE_FORMAT(`Data`, \'%d/%m/%Y\')', 133, 7, FALSE, '`Data`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Data->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['Data'] = &$this->Data;

		// Horario
		$this->Horario = new cField('agenda', 'agenda', 'x_Horario', 'Horario', '`Horario`', 'DATE_FORMAT(`Horario`, \'%d/%m/%Y\')', 134, -1, FALSE, '`Horario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Horario->FldDefaultErrMsg = $Language->Phrase("IncorrectTime");
		$this->fields['Horario'] = &$this->Horario;

		// Assunto
		$this->Assunto = new cField('agenda', 'agenda', 'x_Assunto', 'Assunto', '`Assunto`', '`Assunto`', 200, -1, FALSE, '`Assunto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Assunto'] = &$this->Assunto;

		// Tarefa
		$this->Tarefa = new cField('agenda', 'agenda', 'x_Tarefa', 'Tarefa', '`Tarefa`', '`Tarefa`', 201, -1, FALSE, '`Tarefa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Tarefa'] = &$this->Tarefa;

		// Resolvido
		$this->Resolvido = new cField('agenda', 'agenda', 'x_Resolvido', 'Resolvido', '`Resolvido`', '`Resolvido`', 16, -1, FALSE, '`Resolvido`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`Data` ASC,`Horario` ASC";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("agendaview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("agendaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "agendaadd.php?" . $this->UrlParm($parm);
		else
			return "agendaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("agendaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("agendaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("agendadelete.php", $this->UrlParm());
	}
