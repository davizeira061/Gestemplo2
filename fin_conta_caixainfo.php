...
$fin_conta_caixa = NULL;

//
// Table class for fin_conta_caixa
//
class cfin_conta_caixa extends cTable {
	var $Id;
	var $Tipo;
	var $Conta_Caixa;
	...
	function __construct() {
		...
		$this->TableVar = 'fin_conta_caixa';
		$this->TableName = 'fin_conta_caixa';
		...
		// Id
		$this->Id = new cField('fin_conta_caixa', 'fin_conta_caixa', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id'] = &$this->Id;

		// Tipo
		$this->Tipo = new cField('fin_conta_caixa', 'fin_conta_caixa', 'x_Tipo', 'Tipo', '`Tipo`', '`Tipo`', 3, -1, FALSE, '`Tipo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Tipo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Tipo'] = &$this->Tipo;

		// Conta_Caixa
		$this->Conta_Caixa = new cField('fin_conta_caixa', 'fin_conta_caixa', 'x_Conta_Caixa', 'Conta_Caixa', '`Conta_Caixa`', '`Conta_Caixa`', 200, -1, FALSE, '`Conta_Caixa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`fin_conta_caixa`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`Tipo` ASC";
	}
	...
	// Update Table
	var $UpdateTable = "`fin_conta_caixa`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "fin_conta_caixalist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("fin_conta_caixaview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("fin_conta_caixaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "fin_conta_caixaadd.php?" . $this->UrlParm($parm);
		else
			return "fin_conta_caixaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("fin_conta_caixaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("fin_conta_caixaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("fin_conta_caixadelete.php", $this->UrlParm());
	}
