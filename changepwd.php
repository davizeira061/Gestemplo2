	...
	function Page_Main() {
		...
		if ($bPostBack && $bValidate) {
			...
			if ($rs = $conn->Execute($sSql)) {
				if (!$rs->EOF) {
					$rsold = $rs->fields;
					if (ew_ComparePassword($rsold['senha'], $this->OldPassword)) {
						$bValidPwd = TRUE;
...
<?php } ?>
	<div class="form-group">
		...
		<div class="col-sm-10 input-group"><div class="input-group-addon"><i class="fa fa-key"></i></div><input type="password" name="opwd" id="opwd" class="form-control ewControl"></div>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="npwd"><?php echo $Language->Phrase("NewPassword") ?></label>
		<div class="col-sm-10 input-group"><div class="input-group-addon"><i class="fa fa-lock"></i></div><input type="password" name="npwd" id="npwd" class="form-control ewControl"></div>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="cpwd"><?php echo $Language->Phrase("ConfirmPassword") ?></label>
		<div class="col-sm-10 input-group"><div class="input-group-addon"><i class="fa fa-lock"></i></div><input type="password" name="cpwd" id="cpwd" class="form-control ewControl"></div>
	</div>
	<div class="form-group">
