...
$EtiquetasMalaDireta = NULL;

//
// Table class for EtiquetasMalaDireta
//
class cEtiquetasMalaDireta extends cTable {
	var $Nome;
	...
	function __construct() {
		...
		$this->TableVar = 'EtiquetasMalaDireta';
		$this->TableName = 'EtiquetasMalaDireta';
		...
		// Nome
		$this->Nome = new cField('EtiquetasMalaDireta', 'EtiquetasMalaDireta', 'x_Nome', 'Nome', 'membro.Nome', 'membro.Nome', 200, -1, FALSE, 'membro.Nome', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nome'] = &$this->Nome;

		// CargoMinisterial
		$this->CargoMinisterial = new cField('EtiquetasMalaDireta', 'EtiquetasMalaDireta', 'x_CargoMinisterial', 'CargoMinisterial', 'membro.CargoMinisterial', 'membro.CargoMinisterial', 16, -1, FALSE, 'membro.CargoMinisterial', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Funcao
		$this->Funcao = new cField('EtiquetasMalaDireta', 'EtiquetasMalaDireta', 'x_Funcao', 'Funcao', 'membro.Funcao', 'membro.Funcao', 16, -1, FALSE, 'membro.Funcao', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Funcao->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Funcao'] = &$this->Funcao;

		// Mes
		$this->Mes = new cField('EtiquetasMalaDireta', 'EtiquetasMalaDireta', 'x_Mes', 'Mes', 'Month(membro.DataNasc)', 'Month(membro.DataNasc)', 20, -1, FALSE, 'Month(membro.DataNasc)', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Mes->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Mes'] = &$this->Mes;

		// Endereco
		$this->Endereco = new cField('EtiquetasMalaDireta', 'EtiquetasMalaDireta', 'x_Endereco', 'Endereco', 'membro.Endereco', 'membro.Endereco', 200, -1, FALSE, 'membro.Endereco', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Endereco'] = &$this->Endereco;

		// Bairro
		$this->Bairro = new cField('EtiquetasMalaDireta', 'EtiquetasMalaDireta', 'x_Bairro', 'Bairro', 'membro.Bairro', 'membro.Bairro', 200, -1, FALSE, 'membro.Bairro', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Bairro'] = &$this->Bairro;

		// Cidade
		$this->Cidade = new cField('EtiquetasMalaDireta', 'EtiquetasMalaDireta', 'x_Cidade', 'Cidade', 'membro.Cidade', 'membro.Cidade', 200, -1, FALSE, 'membro.Cidade', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Cidade'] = &$this->Cidade;

		// CEP
		$this->CEP = new cField('EtiquetasMalaDireta', 'EtiquetasMalaDireta', 'x_CEP', 'CEP', 'membro.CEP', 'membro.CEP', 200, -1, FALSE, 'membro.CEP', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CEP'] = &$this->CEP;

		// UF
		$this->UF = new cField('EtiquetasMalaDireta', 'EtiquetasMalaDireta', 'x_UF', 'UF', 'membro.UF', 'membro.UF', 200, -1, FALSE, 'membro.UF', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['UF'] = &$this->UF;

		// Sexo
		$this->Sexo = new cField('EtiquetasMalaDireta', 'EtiquetasMalaDireta', 'x_Sexo', 'Sexo', 'membro.Sexo', 'membro.Sexo', 202, -1, FALSE, 'membro.Sexo', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Sexo'] = &$this->Sexo;

		// EstadoCivil
		$this->EstadoCivil = new cField('EtiquetasMalaDireta', 'EtiquetasMalaDireta', 'x_EstadoCivil', 'EstadoCivil', 'membro.EstadoCivil', 'membro.EstadoCivil', 202, -1, FALSE, 'membro.EstadoCivil', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['EstadoCivil'] = &$this->EstadoCivil;

		// Rede_Ministerial
		$this->Rede_Ministerial = new cField('EtiquetasMalaDireta', 'EtiquetasMalaDireta', 'x_Rede_Ministerial', 'Rede_Ministerial', 'membro.Rede_Ministerial', 'membro.Rede_Ministerial', 16, -1, FALSE, 'membro.Rede_Ministerial', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Celula
		$this->Celula = new cField('EtiquetasMalaDireta', 'EtiquetasMalaDireta', 'x_Celula', 'Celula', 'membro.Celula', 'membro.Celula', 3, -1, FALSE, 'membro.Celula', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Celula->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
	...
	function getSqlSelect() { // Select
		return ($this->_SqlSelect <> "") ? $this->_SqlSelect : "SELECT membro.Nome, membro.Endereco, membro.Bairro, membro.Cidade, membro.CEP, membro.UF, Month(membro.DataNasc) AS Mes, membro.CargoMinisterial, membro.Funcao, membro.Sexo, membro.EstadoCivil, membro.Rede_Ministerial, membro.Celula FROM " . $this->getSqlFrom();
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "etiquetasmaladiretalist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("etiquetasmaladiretaview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("etiquetasmaladiretaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "etiquetasmaladiretaadd.php?" . $this->UrlParm($parm);
		else
			return "etiquetasmaladiretaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("etiquetasmaladiretaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("etiquetasmaladiretaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("etiquetasmaladiretadelete.php", $this->UrlParm());
	}
