...
$agenda_edit = NULL; // Initialize page object first

class cagenda_edit extends cagenda {
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "")
			$this->Page_Terminate("agendalist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($agenda_edit)) $agenda_edit = new cagenda_edit();

// Page init
$agenda_edit->Page_Init();

// Page main
$agenda_edit->Page_Main();
...
// Page object
var agenda_edit = new ew_Page("agenda_edit");
agenda_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = agenda_edit.PageID; // For backward compatibility

// Form object
var fagendaedit = new ew_Form("fagendaedit");
...
fagendaedit.Form_CustomValidate = 
...
fagendaedit.ValidateRequired = true;
<?php } else { ?>
fagendaedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fagendaedit.Lists["x_Prioridade"] = {"LinkField":"x_Id_prior","Ajax":null,"AutoFill":false,"DisplayFields":["x_Prioridade","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fagendaedit.Lists["x_Resolvido"] = {"LinkField":"x_Id","Ajax":null,"AutoFill":false,"DisplayFields":["x_solucao","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fagendaedit" id="fagendaedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($agenda_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $agenda_edit->Token ?>">
<?php } ?>
...
<script type="text/javascript">
fagendaedit.Lists["x_Prioridade"].Options = <?php echo (is_array($agenda->Prioridade->EditValue)) ? ew_ArrayToJson($agenda->Prioridade->EditValue, 0) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("fagendaedit", "x_Data", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<script type="text/javascript">ew_CreateTimePicker("fagendaedit", "x_Horario", {"timeFormat":"H:i:s"});</script><?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateEditor("fagendaedit", "x_Tarefa", 70, 4, <?php echo ($agenda->Tarefa->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<script type="text/javascript">
fagendaedit.Lists["x_Resolvido"].Options = <?php echo (is_array($agenda->Resolvido->EditValue)) ? ew_ArrayToJson($agenda->Resolvido->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<span id="el_agenda_id">
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($agenda->id->CurrentValue) ?>">
</span>
