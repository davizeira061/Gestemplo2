...
<?php if ($eventos->Evento->Visible) { // Evento ?>
		<th><span id="elh_eventos_Evento" class="eventos_Evento"><?php echo $eventos->Evento->FldCaption() ?></span></th>
<?php } ?>
<?php if ($eventos->DataInicio->Visible) { // DataInicio ?>
		<th><span id="elh_eventos_DataInicio" class="eventos_DataInicio"><?php echo $eventos->DataInicio->FldCaption() ?></span></th>
<?php } ?>
<?php if ($eventos->DataTermino->Visible) { // DataTermino ?>
		<th><span id="elh_eventos_DataTermino" class="eventos_DataTermino"><?php echo $eventos->DataTermino->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $eventos_delete->RowCnt ?>_eventos_Evento" class="form-group eventos_Evento">
...
<span id="el<?php echo $eventos_delete->RowCnt ?>_eventos_DataInicio" class="form-group eventos_DataInicio">
...
<span id="el<?php echo $eventos_delete->RowCnt ?>_eventos_DataTermino" class="form-group eventos_DataTermino">
