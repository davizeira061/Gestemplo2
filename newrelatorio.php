...
if ($dados['status'] == "Inativo"){
    ...
    <section>
        <div class="container">
            ...
            <hr>
            <div class="row">
                <form method="post" action="process/envianovorelatorio.php">
                    <div class="col-sm-3">
                        Data da Reúnião:
                        <input type="text" name="DataReuniao" class="form-control" required>
                    </div>
                    <div class="col-sm-4">
                        Tema Reunião:
                        <?php
                    ...
                    <div class="col-sm-5">
                        ...
                        if ($_SESSION['nivel'] == 1 || $_SESSION['nivel'] == 2){
                            ...
                            $queryLider = "select * from lider where idLider = '$id'";
                        }
                        ...
                        <select name="Lider" class="form-control" required>
                            <?php while ($lider = mysqli_fetch_array($resultLider)){ ?>
                                <option value="<?php print $lider['idLider']?>"><?php print $lider['nome']?>  ||  <?php print $lider['nomePG']?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-2">
                        Maiores de 12 Anos:
                        <input id="valor1" type="number" name="CrenteMaior12" class="form-control" required>
                    </div>
                    <div class="col-sm-2">
                        Menores de 12 Anos:
                        <input id="valor2" type="number" name="CrenteMenores12" class="form-control">
                    </div>
                    <div class="col-sm-12">
                        <br/>
                    ...
                    <div class="col-sm-2">
                        Maiores de 12 Anos:
                        <input id="valor3" type="number" name="NaoCrenteMaior12" class="form-control">
                    </div>
                    <div class="col-sm-2">
                        Menores de 12 Anos:
                        <input id="valor4" type="number" name="NaoCrenteMenores12" class="form-control">
                    </div>
                    <div class="col-sm-12">
                        <br/>
                    ...
                    <div class="col-sm-2">
                        Total de Pessoas:
                        <input id="total" type="number" name="TotalPessoas" class="form-control" onload="somarPessoas()" required>
                    </div>
                    <div class="col-sm-10">
                        Observações quanto a quantidade de participantes nesta reunião:
                        <input type="text" name="ObsPessoas" class="form-control" required>
                    </div>
                    <div class="col-sm-12">
                        Impressões do líder quanto a lição:
                        <input type="text" name="ObsLicao" class="form-control" required>
                    </div>
                    <div class="col-sm-12">
                        <br/>
                    ...
                    <div class="col-sm-12">
                        <textarea name="PedOracao" class="form-control" rows="6"></textarea>
                    </div>
                    <div class="col-sm-12">
                        <br/>
                        <?php
                        ...
                        while ($dPart = mysqli_fetch_array($rPart)){ ?>
                            <div class="checkbox-inline">
                                <label>
                                    <input type="checkbox" name="presenca_<?php print $dPart['id_part']?>" value="<?php print $dPart['id_part']?>" > <?php print $dPart['nome_part']?>
                                </label>
                            </div>
                        <?php } ?>
                    </div>
