...
class caudittrail extends cTable {
	...
	function __construct() {
		...
		// datetime
		$this->datetime = new cField('audittrail', 'audittrail', 'x_datetime', 'datetime', '`datetime`', 'DATE_FORMAT(`datetime`, \'%d/%m/%Y\')', 135, 11, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`datetime` DESC";
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->datetime->EditValue = ew_HtmlEncode(ew_FormatDateTime($this->datetime->CurrentValue, 11));
