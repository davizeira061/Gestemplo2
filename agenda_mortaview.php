...
$Agenda_Morta_view = NULL; // Initialize page object first

class cAgenda_Morta_view extends cAgenda_Morta {
	...
	// Page object name
	var $PageObjName = 'Agenda_Morta_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "agenda_mortalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "agenda_mortalist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "agenda_mortalist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($Agenda_Morta_view)) $Agenda_Morta_view = new cAgenda_Morta_view();

// Page init
$Agenda_Morta_view->Page_Init();

// Page main
$Agenda_Morta_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$Agenda_Morta_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var Agenda_Morta_view = new ew_Page("Agenda_Morta_view");
Agenda_Morta_view.PageID = "view"; // Page ID
var EW_PAGE_ID = Agenda_Morta_view.PageID; // For backward compatibility

// Form object
var fAgenda_Mortaview = new ew_Form("fAgenda_Mortaview");

// Form_CustomValidate event
fAgenda_Mortaview.Form_CustomValidate = 
...
fAgenda_Mortaview.ValidateRequired = true;
<?php } else { ?>
fAgenda_Mortaview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fAgenda_Mortaview.Lists["x_Prioridade"] = {"LinkField":"x_Id_prior","Ajax":null,"AutoFill":false,"DisplayFields":["x_Prioridade","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fAgenda_Mortaview.Lists["x_Resolvido"] = {"LinkField":"x_Id","Ajax":null,"AutoFill":false,"DisplayFields":["x_solucao","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $Agenda_Morta_view->ExportOptions->Render("body") ?>
<?php
	foreach ($Agenda_Morta_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $Agenda_Morta_view->ShowPageHeader(); ?>
<?php
$Agenda_Morta_view->ShowMessage();
?>
<form name="fAgenda_Mortaview" id="fAgenda_Mortaview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($Agenda_Morta_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $Agenda_Morta_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="Agenda_Morta">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($Agenda_Morta->Prioridade->Visible) { // Prioridade ?>
	<tr id="r_Prioridade">
		<td><span id="elh_Agenda_Morta_Prioridade"><?php echo $Agenda_Morta->Prioridade->FldCaption() ?></span></td>
		<td<?php echo $Agenda_Morta->Prioridade->CellAttributes() ?>>
<span id="el_Agenda_Morta_Prioridade" class="form-group">
<span<?php echo $Agenda_Morta->Prioridade->ViewAttributes() ?>>
<?php echo $Agenda_Morta->Prioridade->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($Agenda_Morta->Data->Visible) { // Data ?>
	<tr id="r_Data">
		<td><span id="elh_Agenda_Morta_Data"><?php echo $Agenda_Morta->Data->FldCaption() ?></span></td>
		<td<?php echo $Agenda_Morta->Data->CellAttributes() ?>>
<span id="el_Agenda_Morta_Data" class="form-group">
<span<?php echo $Agenda_Morta->Data->ViewAttributes() ?>>
<?php echo $Agenda_Morta->Data->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($Agenda_Morta->Horario->Visible) { // Horario ?>
	<tr id="r_Horario">
		<td><span id="elh_Agenda_Morta_Horario"><?php echo $Agenda_Morta->Horario->FldCaption() ?></span></td>
		<td<?php echo $Agenda_Morta->Horario->CellAttributes() ?>>
<span id="el_Agenda_Morta_Horario" class="form-group">
<span<?php echo $Agenda_Morta->Horario->ViewAttributes() ?>>
<?php echo $Agenda_Morta->Horario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($Agenda_Morta->Assunto->Visible) { // Assunto ?>
	<tr id="r_Assunto">
		<td><span id="elh_Agenda_Morta_Assunto"><?php echo $Agenda_Morta->Assunto->FldCaption() ?></span></td>
		<td<?php echo $Agenda_Morta->Assunto->CellAttributes() ?>>
<span id="el_Agenda_Morta_Assunto" class="form-group">
<span<?php echo $Agenda_Morta->Assunto->ViewAttributes() ?>>
<?php echo $Agenda_Morta->Assunto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($Agenda_Morta->Tarefa->Visible) { // Tarefa ?>
	<tr id="r_Tarefa">
		<td><span id="elh_Agenda_Morta_Tarefa"><?php echo $Agenda_Morta->Tarefa->FldCaption() ?></span></td>
		<td<?php echo $Agenda_Morta->Tarefa->CellAttributes() ?>>
<span id="el_Agenda_Morta_Tarefa" class="form-group">
<span<?php echo $Agenda_Morta->Tarefa->ViewAttributes() ?>>
<?php echo $Agenda_Morta->Tarefa->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($Agenda_Morta->Resolvido->Visible) { // Resolvido ?>
	<tr id="r_Resolvido">
		<td><span id="elh_Agenda_Morta_Resolvido"><?php echo $Agenda_Morta->Resolvido->FldCaption() ?></span></td>
		<td<?php echo $Agenda_Morta->Resolvido->CellAttributes() ?>>
<span id="el_Agenda_Morta_Resolvido" class="form-group">
<span<?php echo $Agenda_Morta->Resolvido->ViewAttributes() ?>>
<?php echo $Agenda_Morta->Resolvido->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fAgenda_Mortaview.Init();
</script>
<?php
$Agenda_Morta_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$Agenda_Morta_view->Page_Terminate();
?>
