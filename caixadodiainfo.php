...
//
// Table class for caixadodia
//
class ccaixadodia extends cTable {
	var $Id;
	var $Tipo;
	var $Conta_Caixa;
	var $Situacao;
	...
	function __construct() {
		...
		$this->TableVar = 'caixadodia';
		$this->TableName = 'caixadodia';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// Id
		$this->Id = new cField('caixadodia', 'caixadodia', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id'] = &$this->Id;

		// Tipo
		$this->Tipo = new cField('caixadodia', 'caixadodia', 'x_Tipo', 'Tipo', '`Tipo`', '`Tipo`', 16, -1, FALSE, '`Tipo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Tipo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Tipo'] = &$this->Tipo;

		// Conta_Caixa
		$this->Conta_Caixa = new cField('caixadodia', 'caixadodia', 'x_Conta_Caixa', 'Conta_Caixa', '`Conta_Caixa`', '`Conta_Caixa`', 3, -1, FALSE, '`Conta_Caixa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Conta_Caixa->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Conta_Caixa'] = &$this->Conta_Caixa;

		// Situacao
		$this->Situacao = new cField('caixadodia', 'caixadodia', 'x_Situacao', 'Situacao', '`Situacao`', '`Situacao`', 16, -1, FALSE, '`Situacao`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Situacao->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Situacao'] = &$this->Situacao;

		// Descricao
		$this->Descricao = new cField('caixadodia', 'caixadodia', 'x_Descricao', 'Descricao', '`Descricao`', '`Descricao`', 200, -1, FALSE, '`Descricao`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Descricao'] = &$this->Descricao;

		// id_discipulo
		$this->id_discipulo = new cField('caixadodia', 'caixadodia', 'x_id_discipulo', 'id_discipulo', '`id_discipulo`', '`id_discipulo`', 3, -1, FALSE, '`id_discipulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_discipulo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_discipulo'] = &$this->id_discipulo;

		// Receitas
		$this->Receitas = new cField('caixadodia', 'caixadodia', 'x_Receitas', 'Receitas', '`Receitas`', '`Receitas`', 131, -1, FALSE, '`Receitas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Receitas->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Receitas'] = &$this->Receitas;

		// Despesas
		$this->Despesas = new cField('caixadodia', 'caixadodia', 'x_Despesas', 'Despesas', '`Despesas`', '`Despesas`', 131, -1, FALSE, '`Despesas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Despesas->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Despesas'] = &$this->Despesas;

		// FormaPagto
		$this->FormaPagto = new cField('caixadodia', 'caixadodia', 'x_FormaPagto', 'FormaPagto', '`FormaPagto`', '`FormaPagto`', 16, -1, FALSE, '`FormaPagto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->FormaPagto->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['FormaPagto'] = &$this->FormaPagto;

		// N_Documento
		$this->N_Documento = new cField('caixadodia', 'caixadodia', 'x_N_Documento', 'N_Documento', '`N_Documento`', '`N_Documento`', 200, -1, FALSE, '`N_Documento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['N_Documento'] = &$this->N_Documento;

		// Dt_Lancamento
		$this->Dt_Lancamento = new cField('caixadodia', 'caixadodia', 'x_Dt_Lancamento', 'Dt_Lancamento', '`Dt_Lancamento`', 'DATE_FORMAT(`Dt_Lancamento`, \'%d/%m/%Y\')', 133, 7, FALSE, '`Dt_Lancamento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Vencimento
		$this->Vencimento = new cField('caixadodia', 'caixadodia', 'x_Vencimento', 'Vencimento', '`Vencimento`', 'DATE_FORMAT(`Vencimento`, \'%d/%m/%Y\')', 133, 7, FALSE, '`Vencimento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Vencimento->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['Vencimento'] = &$this->Vencimento;

		// Centro_de_Custo
		$this->Centro_de_Custo = new cField('caixadodia', 'caixadodia', 'x_Centro_de_Custo', 'Centro_de_Custo', '`Centro_de_Custo`', '`Centro_de_Custo`', 3, -1, FALSE, '`Centro_de_Custo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`caixadodia`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("caixadodiaview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("caixadodiaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "caixadodiaadd.php?" . $this->UrlParm($parm);
		else
			return "caixadodiaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("caixadodiaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("caixadodiaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("caixadodiadelete.php", $this->UrlParm());
	}
